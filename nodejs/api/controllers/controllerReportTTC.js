...
module.exports = {
	...
	deepQuery: function (req, res) { 
		...
		var sStatement = 
			...
			+'pagamento."projeto" as "ProjetoPagamento", '
			+'pagamento."descricao" as "DescricaoPagamento", '
			+'pagamento."tipo_transacao_outros" as "TipoTransacaoOutrosPagamento", '
			+'pagamento."principal" as "PrincipalPagamento", '
			+'pagamento."juros" as "JurosPagamento", '
			+'pagamento."multa" as "MultaPagamento", '
			+'pagamento."total" as "TotalPagamento", '
			+'pagamento."numero_documento" as "NumeroDocumentoPagamento", '
			+'pagamento."entidade_beneficiaria" as "EntidadeBeneficiariaPagamento", '			
			...
			+'left outer join "VGT.DOMINIO_PAIS" as dominio_pais on dominio_pais."id_dominio_pais" = pagamento."fk_dominio_pais.id_dominio_pais" '
