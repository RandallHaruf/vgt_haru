	...
	deepQuery: function (req, res) {
		var sStatement = 
			'select pais."id_pais" "id", '
				...
				+ 'left outer join ( '
					+ 'select aliquota."nome",valor_aliquota."valor",aliquota."id_aliquota" from "VGT.ALIQUOTA" aliquota '
					+ 'left outer join "VGT.VALOR_ALIQUOTA" AS valor_aliquota ' 
						+ 'on valor_aliquota."fk_aliquota.id_aliquota" = aliquota."id_aliquota" ' 
					...
					+ 'where (aliquota."fk_dominio_aliquota_tipo.id_dominio_aliquota_tipo" = 1 and ano_fiscal."ano_fiscal" = year(current_date) or aliquota."fk_dominio_aliquota_tipo.id_dominio_aliquota_tipo" is null and ano_fiscal."ano_fiscal" is null) '
				+ ') tblFusao '
					+ 'on pais."fk_aliquota.id_aliquota" = tblFusao."id_aliquota" ' 
