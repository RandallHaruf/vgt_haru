...
const model = require('../models/modelRelEmpresaModulo');
...
module.exports = {
	...
	listarRegistros: (req, res, next) => {
		try {
			...
			console.log(e);
			let msg = 'Erro inesperado no método "controllerRelEmpresaModulo/listarRegistros": ' + e.message;
	...
	criarRegistro: (req, res, next) => {
		try {
			...
			console.log(e);
			let msg = 'Erro inesperado no método "controllerRelEmpresaModulo/criarRegistro": ' + e.message;
			const error = new Error(msg);
			next(error);
		}
	},
	...
	lerRegistro: (req, res, next) => {
		try {
			...
			console.log(e);
			let msg = 'Erro inesperado no método "controllerRelEmpresaModulo/lerRegistro": ' + e.message;
			const error = new Error(msg);
			next(error);
		}
	},
	...
	atualizarRegistro: (req, res, next) => {
		try {
			...
			console.log(e);
			let msg = 'Erro inesperado no método "controllerRelEmpresaModulo/atualizarRegistro": ' + e.message;
			const error = new Error(msg);
			next(error);
		}
	},
	...
	excluirRegistro: (req, res, next) => {
		try {
			...
			console.log(e);
			let msg = 'Erro inesperado no método "controllerRelEmpresaModulo/excluirRegistro": ' + e.message;
			const error = new Error(msg);
			next(error);
		}
	},
	...
	deepQuery: (req, res, next) => {
		res.send('TODO: DeepQuery da Entidade RelEmpresaModulo');
		...
		console.log(e);
		let msg = 'Erro inesperado no método "controllerRelEmpresaModulo/deepQuery": ' + e.message;
		const error = new Error(msg);
		next(error);
		}*/
	}
