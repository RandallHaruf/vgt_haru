...
var model = require("../models/modelDomMoeda");
...
module.exports = {
	...
	criarRegistro: function (req, res) {
		...
		var aParams = [{
			...
			coluna: model.colunas.acronimo,
			valor: req.body.acronimo ? req.body.acronimo : null
		}, {
	...
	deepQuery: function (req, res) {
		res.send("TODO: DeepQuery da Entidade DominioMoeda");
