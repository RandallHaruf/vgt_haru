...
], function (jQuery, Controller, MessageToast, MessageBox, JSONModel, models, BaseController) {
	"use strict";

	return BaseController.extend("ui5ns.ui5.controller.compliance.RepositorioDocumentos", {
		getBase64: function (file) {
			...
			sap.m.MessageToast.show(JSON.stringify(file));
		},
		...
		onInit: function () {
			// set mock data
			this.oModel = new JSONModel(models.createDocumentsModelParaRepositorioCompliance());
