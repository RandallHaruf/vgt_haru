sap.ui.define([
	...
	return BaseController.extend("ui5ns.ui5.controller.taxPackage.RelatorioCreditSchedule", {
		onInit: function () {
			...
			var that = this;
			this.getModel().setProperty("/NomeReport",this.getResourceBundle().getText("viewGeralRelatorio") + " " + this.getResourceBundle().getText("viewTaxpackageEdiçãoTrimestreCreditSchedule"));
		...
		*/
		onDataExport : sap.m.Table.prototype.exportData || function(tipo) {
			Utils.dataExportReport(this,tipo,"viewTaxpackageEdiçãoTrimestreCreditSchedule","viewTaxpackageEdiçãoTrimestreCreditSchedule");  
